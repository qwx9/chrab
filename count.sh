...
bedtools map -c 4 -o mean -null 0 -a prep/hg19w.bed -b prep/huvec.h3k9me3.bed.gz |\
	gzip -c >cnt/huvec.h3k9me3.mean.bed.gz
bedtools map -c 4 -o sum -null 0 -a prep/hg19w.bed -b prep/huvec.h3k9me3.bed.gz |\
	gzip -c >cnt/huvec.h3k9me3.sum.bed.gz
bedtools coverage -a prep/ab.bed -b prep/huvec.h3k9me3.bed.gz |\
	awk '{print $1 "\t" $2 "\t" $3 "\t" $11}' |\
	gzip -c >cnt/huvec.h3k9me3.coverage.bed.gz
